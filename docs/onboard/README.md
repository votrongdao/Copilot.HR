...
## Onboarding Sitemap 
![alt text](../../images/sitemap/onboard-sitemap.png)

## Onboarding Use Case
![alt text](<../../images/usecase/HR Platform Usecase-Onboarding.png>)
...
![alt text](../../images/erd/onboard/api1.png) 
![alt text](../../images/erd/onboard/api2.png) 
![alt text](../../images/erd/onboard/api3.png)
```text

...
![alt text](project-management/usecase/Project-Management.drawio.png)

## III. UI/UX

### Staff

![alt text](project-management/UI/Employee-My-Project.png)

![alt text](project-management/UI/Employee-Project-Detail.png)

![alt text](project-management/UI/Employee-My-Capacity.png)

![alt text](project-management/UI/Employee-My-Productivity.png)

![alt text](project-management/UI/Employee-My-Time.png)

### Manager

![alt text](project-management/UI/PM-Projects-Dashboard.png)

![alt text](project-management/UI/PM-Project-Detail-View.png)

![alt text](project-management/UI/PM-Create-Project-Form.png)

![alt text](project-management/UI/PM-Project-Members-List.png)

![alt text](project-management/UI/PM-Add-Project-Member-Drawer.png)

![alt text](project-management/UI/PM-Project-Capacity-View.png)

![alt text](project-management/UI/PM-Resource-Allocation.png)

![alt text](project-management/UI/PM-Time-Tracking.png)

![alt text](project-management/UI/PM-Timesheet-Review.png)

![alt text](project-management/UI/PM-Team-Productivity.png)

![alt text](project-management/UI/PM-Employee-Productivity-Detail.png)

![alt text](project-management/UI/PM-Project-Budget.png)

### HR

![alt text](project-management/UI/HR-Capacity-Overview.png)

![alt text](project-management/UI/HR-Resource-Overview.png)

![alt text](project-management/UI/HR-Overtime-&-Training.png)

![alt text](project-management/UI/HR-Utilization.png)

## IV. Database

### Project Setup & Management, Project Member & Allocation, Project Effort / Time Tracking

![alt text](project-management/database/project-setup.png)

### Capability Management + Budget Management

![alt text](project-management/database/capacity-management.png)

### Productivity Monitoring

![alt text](project-management/database/productivity-monitoring.png)
